...
def Incluir():
    ...
    if input_button_submit:
        ...
        PontosController.Incluir(pts.Pontos(0,input_code,input_name,input_date,input_lat,input_long,input_cultura,input_altitude,input_temp,input_tpsafra))

        st.success("Ponto Incluido com Sucesso!")
